...
describe("Is xxx binary tree", () => {
  it("get lowest common node1", () => {
    expect(JSON.stringify(lowestCommon(root, o3, o4))).toEqual(
      JSON.stringify(o1)
    );
  });

  it("get lowest common node2", () => {
    expect(JSON.stringify(lowestCommon(root, o2, o6))).toEqual(
      JSON.stringify(o2)
    );
  });

  it("get lowest common node3", () => {
    expect(JSON.stringify(lowestCommon(root, o3, o6))).toEqual(
      JSON.stringify(root)
    );
  });
